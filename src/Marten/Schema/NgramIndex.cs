...
namespace Marten.Schema
{
    ...
    public class NgramIndex : IIndexDefinition
    {
        ...
        public string ToDDL()
        {
            return $"CREATE INDEX {IndexName}_{_dataConfig} ON {_table.QualifiedName} USING gin (( mt_ngram_tsvector( {_dataConfig}) ));";
        }
        ...
        public bool Matches(ActualIndex index)
        {
            ...
            // Check for the existence of the 'ngram_tsvector' function, the correct table name, and the use of the data column
            return ddl.Contains("mt_ngram_tsvector") == true
